...
Op basis van de noden die geïdentificeerd werden in de literatuur en de gespreken met huisartsen binnen eerstelijnszone Aalst worden vijf functionele vereisten geformuleerd waaraan de ideale tool moet voldoen \autocite{Merckx2023}:

\begin{enumerate}
  \item \textbf{Dynamische vragen}: de vragenlijst past zich aan op basis van eerder gegeven antwoorden.
  \item \textbf{distributie mogelijkheden}: de tool kan worden geïntigreerd in een applicatie via embedding, een API of webhooks.
