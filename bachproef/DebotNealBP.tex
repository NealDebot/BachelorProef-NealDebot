...
\title%
    {Ontwikkeling en evaluatie van een proof-of-concept interface voor het efficiënt beoordelen van de toegangkelijkheid van Vlaamse huisartsenpraktijken}
