...
In hoofdstuk~\ref{ch:concept} wordt het concept en het ontwerp van de proof-of-concept besproken.

In Hoofdstuk~\ref{ch:implementatie} wordt de effectieve implementatie van de proof-of-concept besproken.

In Hoofdstuk~\ref{ch:gebruikerstesting} wordt de test fase van de proof-of-concept besproken.
